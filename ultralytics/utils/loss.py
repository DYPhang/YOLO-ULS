...
from ultralytics.utils.tal import TaskAlignedAssigner, dist2bbox, make_anchors,dist2rbox
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask, para=None):
        """IoU loss."""
